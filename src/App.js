...
const App = () => {
  ...
  const res = query ? products.filter((e) => e.name.includes(query)) : [];
  return (
    <>
      <Router>
        <PreNavbar></PreNavbar>
          ...
          <Route
            ...
            element={
              <NavOptios
                ...
                redmiPhonesCover={data.redmiPhones}
              />
            }
          />
        </Routes>
        ...
        <Routes>
          <Route
            exact
            path="/tv"
            element={<NavOptios tv={data.tv} tvCover={data.tv} />}
          />
        </Routes>
        ...
        <Routes>
          <Route
            ...
            path="/laptops"
            element={
              <NavOptios laptop={data.laptop} laptopCover={data.laptop} />
            }
          />
        </Routes>
          ...
          <Route
            ...
            element={
              <NavOptios
                ...
                fitnessAndLifeStyleCover={data.fitnessAndLifeStyle}
              />
            }
          />
        </Routes>
        ...
        <Routes>
          <Route
            exact
            path="/home"
            element={<NavOptios home={data.home} homeCover={data.home} />}
          />
        </Routes>
        ...
        <Routes>
          <Route
            exact
            path="/audio"
            element={<NavOptios audio={data.audio} audioCover={data.audio} />}
          />
        </Routes>
